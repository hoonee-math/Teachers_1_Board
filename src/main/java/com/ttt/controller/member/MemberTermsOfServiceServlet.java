...
/**
 * Servlet implementation class MemberTermsOfServiceServlet
 */
@WebServlet("/member/termsofservice")
public class MemberTermsOfServiceServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public MemberTermsOfServiceServlet() {
        super();
